...
if os.path.exists('all.log'):
    os.remove('all.log')
cmdline.execute("scrapy crawl WorkCrawler \
                -a csv_path=D:\\2024Spring\\DLsite-Analysis\\Work_Crawler\\SingleWork_Crawler_V1.0\\日間ランキング.csv \
                -s LOG_FILE=all.log".split())
#'''
'''
