...
if os.path.exists('all.log'):
    os.remove('all.log')
cmdline.execute("scrapy crawl WorksCrawler -a csv_path=D:\\2024Spring\\DLsite-Analysis\\Works_Crawler\\SingleWork_Crawler_V1.7\\日間ランキング.csv -s LOG_FILE=all.log".split())
#'''
'''
