...
def merge_missing_idsjson2json(directory_path, json_file_path):
...
def missingIDS_merge_json2json(directory_path, json_file_path):
    work_dict = {}
...
#merge_txt_to_csv(r'D:\2024Spring\DLsite-Analysis\test_batch', r'D:\2024Spring\DLsite-Analysis\test_batch\Missing.csv')
#missingIDS_check('batches', 'dojinDB.json')
#missingIDS_merge_json2json(r'main_batch', r'main_batch\batches_Missing.json')
merge_missing_idsjson2json('D:\\2024Spring\\DLsite-Analysis\\main_batch', 'D:\\2024Spring\\DLsite-Analysis\\main_batch\\_Missing.json')